...
const NotificationPopup = ({ 
  ...
  return (
    <div className={`fixed ${positionClasses[position]} z-[10000] animate-in fade-in slide-in-from-bottom-5 duration-300`}>
      <div className={`w-96 min-h-24 ${style.bg} outline outline-1 outline-offset-[-1px] ${style.border} rounded-lg overflow-hidden shadow-lg flex items-start gap-4 p-4`}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className={`text-sm font-normal font-aeonik ${style.textColor} break-words line-clamp-2`}>
            {message}
          </p>
        </div>
